...
class="flex flex-col transition-all h-full overflow-hidden">
    ...
    <header class="px-3 z-10 bg-white sticky top-0 w-full py-2">
        ...
        <div class="flex gap-3 items-center overflow-x-scroll p-2 bg-white">
            <button wire:click="filterByType('all')" :class="{'bg-blue-100 border-0 text-black':type=='all'}" class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1 lg:py-2.5 border">
                All
            </button>

            <button wire:click="filterByType('SMS')" :class="{'bg-blue-100 border-0 text-black':type=='SMS'}" class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1 lg:py-2.5 border">
                SMS
            </button>

            <button wire:click="filterByType('Whatsapp')" :class="{'bg-blue-100 border-0 text-black':type=='Whatsapp'}" class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1 lg:py-2.5 border">
                Whatsapp
            </button>
            ...
            <aside class="grid grid-cols-12 w-full">
                ...
                <a href="{{route('chat', $conversation->id)}}" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                    ...
                    <div class="flex gap-x-2 items-center">
                        ...
                        {{-- unread count --}}
                        {{-- <span class="font-bold p-px px-2 text-xs shrink-0 rounded-full bg-blue-500 text-white"></span> --}}
                    </div>
